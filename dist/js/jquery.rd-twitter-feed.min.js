...
h.prototype.construct=function(a){var c,d;var b=this;var e=b.$element.find('[data-twitter-type="tweet"]');var g=c=0;for(d=e.length;0<=d?c<d:c>d;g=0<=d?++c:--c){"A"===e.prop("tagName")&&this.tweetLink(e.eq(g),a[g]);var f=0;e.eq(g).find("*").each(function(){b.parseAttributes(this,a[g],f);this.hasAttribute("data-media_url")&&f++});e.css("opacity","1")}};h.prototype.tweetLink=function(a,c){a.attr("href",c.url)};h.prototype.parseAttributes=function(a,c,d){var b,e;var g=k(a);var f=g.data();for(b in f)if(f.hasOwnProperty(b)){var h=
"string"===typeof f[b]?f[b]:f[b].split(/\s?,\s?/i);var m=0;for(e=h.length;m<e;m++){var l=h[m];"xId"!==l&&("text"===l.toLowerCase()?a.innerHTML=c[b]:"media_url"===b?k.isArray(c[b])&&c[b].length>d?a.setAttribute(l,c[b][d]):null!==c[b]&&0===d?a.setAttribute(l,c[b]):g.remove():a.setAttribute(l,c[b]))}}};k.fn.extend({RDTwitter:function(a){this.each(function(){});var c=k(this);if(!c.data("RDTwitter"))return c.data("RDTwitter",new h(this,a))}});return h}()})(window.jQuery,document,window);"undefined"!==
typeof module&&null!==module?module.exports=window.RDTwitter:"function"===typeof define&&define.amd&&define(["jquery"],function(){return window.RDTwitter})}).call(this);